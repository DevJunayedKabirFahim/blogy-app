                    ...
                    <div class="post-content-body">
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-6 mb-4">
                                <img src="{{asset('/')}}website/images/img_2_horizontal.jpg" alt="Image placeholder" class="img-fluid rounded">
                            </div>
                            <div class="col-md-6 mb-4">
                                <img src="{{asset('/')}}website/images/img_3_horizontal.jpg" alt="Image placeholder" class="img-fluid rounded">
                            </div>
                        </div>
